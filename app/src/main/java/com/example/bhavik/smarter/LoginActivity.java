...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password)) {
            String status = isPasswordValid(password);

            if(status.equals("short")){
                mPasswordView.setError(getString(R.string.error_short_password));
                focusView = mPasswordView;
                cancel = true;
            } else if(status.equals("long")) {
    ...
    public class UserLoginTask extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                jsonResult = AuthConnection.authUser(mEmail, mPassword);
        ...
        @Override
        protected void onPostExecute(final JSONObject jsonResult) {
            mAuthTask = null;
            showProgress(false);
            String status = "";
            String resId = "";
            ...
            try {
                status = jsonResult.get("Status").toString();
            ...
            if (status.equals("Success")) {
                ...
                finish();
                intent.putExtra("fullData", jsonResult.toString());
                ...
                try {
                     ...
                     dataObj = jsonResult.getJSONObject("Cred Data");
